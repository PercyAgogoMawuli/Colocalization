...
#========================
# SECTION 8: Define GWAS Loci
# Clump GWAS SNPs at p < 5e-8; define 1 Mb windows around each lead SNP
#========================

SuSiEColocSummaryFile  <- file.path(OUT_DIR, "FINAL_SuSiE_Coloc_Summary.txt")
SuSiEFailedLog         <- file.path(OUT_DIR, "SuSiE_Failed_Loci_Genes.txt")

bool_SuSiE_Summary_DF <- FALSE
failed_entries        <- list()
